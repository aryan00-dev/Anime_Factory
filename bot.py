...
print("🚀 BRAHMASTRA PHASE: Smart Anime Factory (Genre Edition) Start...")
...
# Genre Folder IDs Jo Tune Diye Hain
GENRE_FOLDERS = {
...
# --- 5. GEMINI ANALYSIS (Scene + Name + Genre) ---
...
Return ONLY JSON: {"start_time": "00:05:10", "end_time": "00:05:45", "hook_text": "Quote", "anime_name": "Name", "genre": "Action"}"""
    ...
    print(f"🎯 Genre Detected: {genre} | Anime: {anime_name}")
...
# --- 7. SMART BGM PICKER ---
print(f"🎶 {genre} folder se random music nikal rahe hain...")
...
if bgm_files:
    ...
    print("⚠️ BGM folder khali hai!"); has_bgm = False

# --- 8. MOVIEPY EDITING (Blur + Text + Audio Mix) ---
...
# Audio Mixing Logic
original_audio = clip.audio.volumex(0.4) # Original aawaz halki
if has_bgm:
...
outro_txt = TextClip(f"ANIME NAME:\n{anime_name}", fontsize=70, color='yellow',
 font='Arial-Bold', method='caption', size=(900, None)).set_position('center').set_duration(outro_bg.duration)
...
print("🎉 MISSION ACCOMPLISHED! Smart Reel Ready Hai!")
